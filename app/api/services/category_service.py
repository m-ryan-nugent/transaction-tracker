...
async def create_category(db: aiosqlite.Connection, category: CategoryCreate) -> CategoryResponse:
...
async def get_category(db: aiosqlite.Connection, category_id: int) -> Optional[CategoryResponse]:
...
async def get_category_by_name(db: aiosqlite.Connection, name: str) -> Optional[CategoryResponse]:
